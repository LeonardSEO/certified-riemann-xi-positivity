...
\label{tab:moments}
\small
\begin{tabular}{@{}c>{\raggedleft\arraybackslash}p{0.34\textwidth}>{\raggedleft\arraybackslash}p{0.34\textwidth}@{}}
\toprule
...
-0.0206557763558942930,\quad
-0.0140554899445716895,\\
&-0.00787928068151705499,\quad
...
source are licensed under CC BY-SA 4.0.  Repository software is licensed under
AGPL-3.0-only.
