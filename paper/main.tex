...
mathematical claims and the released artifacts.  The paper and its LaTeX
source, figures, tables, and supplementary scholarly materials are Copyright
\textcopyright{} 2026 Leonard van Hemert.  All rights reserved.  No permission
is granted to reproduce, redistribute, modify, translate, publish,
commercially exploit, or create derivative works from these materials without
prior written permission, except as permitted by applicable law.  Academic
citation and quotation in accordance with applicable law and scholarly
standards are permitted.  Repository software and certification scripts are
